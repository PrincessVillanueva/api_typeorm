...
let User = (() => {
    ...
    var User = _classThis = class {
        constructor() {
            ...
            this.firstName = (__runInitializers(this, _title_extraInitializers), __runInitializers(this, _firstName_initializers, void 0));
            ...
            __runInitializers(this, _passwordHash_extraInitializers);
        }
    };
